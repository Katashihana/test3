...
const vcard = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            ...
            + 'FN: KATASHI BOT\n' //ganti nama bot lu
            + 'ORG: PUTRA;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6289626029135:+6289626029135\n'  //ganti nomor lu! 
            + 'END:VCARD'
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6289626029135@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["6289626029135@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
...
if (isBanned) return reply('```Lu kebanned kontol```')
                    ...
                    txt = args.join(" ")
                    reply('[❕] Loading')
                    buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/amongus?apikey=7ef1e86bd8624c0edd8bd386&text=${txt}`)
                    client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan Lupa Subrek YT BOT : https://youtube.com/channel/UCMT6vvdujN62xToLZeW2FSA*', quoted: mek})
         break
		...
		case 'galaxtext':
				...
				ct = body.slice(10)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/galaxywallpaper?apikey=7ef1e86bd8624c0edd8bd386&text=${ct}`)
				client.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: mek})
				await limitAdd(sender)
				break
		case 'bplogo':
	...
	break
		...
		case 'imgmaker':
				...
				ainez = body.slice(10)
				reply(ind.wait())
				anu = await fetchJson(`http://lolhuman.herokuapp.com/api/quotemaker?apikey=7ef1e86bd8624c0edd8bd386&text=${ainez}`, {method: 'get'})
				buffer = await getBuffer(anu.result)
				client.sendMessage(from, buffer, image, {caption: 'Nih kak udah jadi..', quoted: mek})
				await limitAdd(sender)
				break
		...
		case 'shota':
				...
				reply(ind.wait())
				buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/toloserti?apikey=7ef1e86bd8624c0edd8bd386&name=${gatauda}`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek})
				await limitAdd(sender)
				break
				case 'tagme':
...
break
         ...
         break 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				reply(ind.wait())
				anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/meme?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
				buffer = await getBuffer(anu.result)
				client.sendMessage(from, buffer, image, {quoted: mek})
				await limitAdd(sender)
				break
				...
				gatauda = body.slice(8)
				reply(ind.wait())
				buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek})
				await limitAdd(sender)
				break
		case 'randomkpop':
		...
		case 'vinta':
                ...
                case 'faktaunik': // Fixed By Pojan
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/faktaunik?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
					reply(anu.result)
					await limitAdd(sender)
					break		
		case 'quotes':
		...
		case 'covidglobal':    
				...
				client.updatePresence(from, Presence.composing) 
			    tels = body.slice(12)
				asu = await fetchJson(`http://lolhuman.herokuapp.com/api/corona/global?apikey=7ef1e86bd8624c0edd8bd386`)
		...
		case 'ceknamaff': 
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					gatauda = body.slice(11)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/freefire/${gatauda}?apikey=7ef1e86bd8624c0edd8bd386`)
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'ceknamaml': 
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					gatauda = body.slice(11)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/mobilelegend/${gatauda}?apikey=7ef1e86bd8624c0edd8bd386`)
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'namaninja': 
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					gatauda = body.slice(11)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/ninja?apikey=7ef1e86bd8624c0edd8bd386&nama=${gatauda}`)
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'infonomor':
...
quoted: mek
  ...
  break
		...
		case 'tampar':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					client.updatePresence(from, Presence.composing) 
					data = await fetchJson(`http://lolhuman.herokuapp.com/api/newsinfo?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
					teks = '=================\n'
					for (let i of data.result) {
...
if (!isRegistered) return reply( ind.noregis())
           ...
           if (!isRegistered) return reply( ind.noregis())
                    ...
                    client.sendMessage(from, thumbnail, image, { quoted: fkontak, caption: ini_txt })
                    await limitAdd(sender) 
                    break
			case 'igtv': 
case 'tvig': 
    ...
    break
               ...
               case 'asupan':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned astagfirullah!')
                    ...
                    txt = args.join(" ")
                    reply('[❕] Loading')
                    buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/carbon?apikey=7ef1e86bd8624c0edd8bd386&code=${txt}`)
                    client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan Lupa  Subrek YT BOT : https://youtube.com/channel/UCMT6vvdujN62xToLZeW2FSA*', quoted: mek})
         break
         ...
         teks = args.join(" ") 
         reply('[❕] Loading') 
         buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/photooxy3/bannerlol?apikey=7ef1e86bd8624c0edd8bd386&text=${teks}`) 
         client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan Lupa  Subrek YT BOT : https://youtube.com/channel/UCMT6vvdujN62xToLZeW2FSA*', quoted: mek})
         break 
         ...
         teks = args.join(" ") 
         reply('[❕] Loading') 
         buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/textprome/text1917?apikey=7ef1e86bd8624c0edd8bd386&text=${teks}`) 
         client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan Lupa  Subrek YT BOT : https://youtube.com/channel/UCMT6vvdujN62xToLZeW2FSA*', quoted: mek})
         break
                case 'pinterest':
					 // Miku Bot
...
if (isBanned) return reply('```Lu kebanned kontol```')
		...
		case 'alay2': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					if (args.length < 1) return reply('kasih teks lah^_^!!!')
					data = await fetchJson(`http://lolhuman.herokuapp.com/api/upperlower?apikey=7ef1e86bd8624c0edd8bd386&text=${body.slice(6)}`)
					reply(data.result)
				        await limitAdd(sender)
					break
		...
		case 'cerpen': 
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/cerpen?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
		...
		case 'quotes': 
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/quotes?apikey=7ef1e86bd8624c0edd8bd386`, {method: 'get'})
		...
		case 'infofilm2': 
                 if (!isRegistered) return reply( ind.noregis())
					...
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
					ige = body.slice(10)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/lk21?apikey=7ef1e86bd8624c0edd8bd386&query=${ige}`)
					buffer7 = await getBuffer(anu.result.thumbnail)
		...
		case 'heroml':  
				...
				if (!isUrl(args[0]) && !args[0].includes('www.instagram.com')) return reply(mess.error.lv)
					 ige = body.slice(9)
                     anu = await fetchJson(`http://lolhuman.herokuapp.com/api/instagram?apikey=7ef1e86bd8624c0edd8bd386&url=${args[0]}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					buffer = await getBuffer(anu.result)
				...
				if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.error.lv)
					 ige = body.slice(12)
                     anu = await fetchJson(`http://lolhuman.herokuapp.com/api/tiktok?apikey=7ef1e86bd8624c0edd8bd386&url=${args[0]}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
		...
		case 'menu':
            //Gk Ush Di Hapus Tod, Dh Susah" Ngefix Di Hapus Sofun kh bgitu?:v
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    shiz = `◪ INFO DEVELOPER
  ► Nama : KatashiBotz
  ► WhatsApp : Wa.me/6289626029135
  ► YouTube : https://youtube.com/channel/katashi-hana
  ----------------------------------
◪ YOUR INFO
  ► Prefix : 「 ${prefix} 」
  ► Nama : ${pushname}
...
caption: teks, contextInfo: {
  ...
  break
		...
		case 'lpr':
					...
					client.sendMessage('6289626029135@s.whatsapp.net', options, text, {quoted: mek})
